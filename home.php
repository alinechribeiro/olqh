...
<style>
    ...
    .e6-1.x-section,.e6-2.x-section,.e6-3.x-section,.e6-4.x-section,.e6-5.x-section,.e6-6.x-section {
        margin:0em;
    ...
    #rs-demo-id {}
    .tp-caption.kb-medium,.kb-medium{font-size:26px;line-height:36px;font-weight:400;font-family:Montserrat;color:rgb(255,255,255);text-decoration:none;background-color:rgba(0,0,0,0);border-width:0px;border-color:rgb(255,214,88);border-style:none;text-transform:uppercase;letter-spacing:5px}.tp-caption.kclarge,.kclarge{font-size:46px;line-height:52px;font-weight:400;font-family:Montserrat;color:#ffffff;text-decoration:none;background-color:rgba(0,0,0,0);border-width:0px;border-color:rgb(255,214,88);border-style:none;text-transform:uppercase;letter-spacing:5px}	#rev_slider_1_1_wrapper .tp-loader.spinner3 div { background-color: #FFFFFF !important; }a,h1 a:hover,h2 a:hover,h3 a:hover,h4 a:hover,h5 a:hover,h6 a:hover,.x-comment-time:hover,#reply-title small a,.comment-reply-link:hover,.x-comment-author a:hover,.x-recent-posts a:hover .h-recent-posts {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      color:#6190a2;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  }
    a:hover,#reply-title small a:hover {
        color:#434f5b;
    ...
    .e8-1.x-section,.e8-2.x-section,.e8-3.x-section,.e8-4.x-section,.e8-5.x-section,.e8-6.x-section,.e8-7.x-section,.e8-8.x-section,.e8-9.x-section,.e8-10.x-section {
        margin:0em;
        padding:45px 0px 45px 0px;
        background-color:transparent;
        z-index:1;
    ...
    .gm-style img { max-width: none; }.html5-video-player {
                                          position:relative;
                                          width:100%;
                                          height:100%;
                                          overflow:hidden;
    ...
    .ytp-transparent .html5-main-video {
        background:#000
    }
    ...
    .ytp-autohide .ytp-playlist-menu-button,.ytp-autohide .ytp-title,.ytp-autohide .ytp-watch-later-button,.ytp-autohide .ytp-share-button,.ytp-autohide:not(.ytp-cards-teaser-shown) .ytp-cards-button,.ytp-autohide .ytp-chrome-bottom,.ytp-chrome-top[aria-hidden=true],.ytp-chrome-bottom[aria-hidden=true] {
        opacity:0;
        -moz-transition:opacity .1s cubic-bezier(0.4,0.0,1,1);
        -webkit-transition:opacity .1s cubic-bezier(0.4,0.0,1,1);
        transition:opacity .1s cubic-bezier(0.4,0.0,1,1)
    ...
    .ytp-hide-info-bar .ytp-gradient-top,.ytp-hide-info-bar .ytp-chrome-top .ytp-title,.ytp-hide-info-bar .ytp-chrome-top .ytp-playlist-menu-button,.ytp-hide-info-bar .ytp-chrome-top .ytp-watch-later-button,.ytp-hide-info-bar .ytp-chrome-top .ytp-share-button {
        display:none
    }
    ...
    .ytp-ad-preview-slot,.ytp-ad-skip-ad-slot {
        text-shadow:0 0 4px rgba(0,0,0,0.75);
        pointer-events:auto
    }
    ...
    .ytp-small-mode .ytp-ad-action-interstitial-card {
    ...
    .ytp-ad-choice-interstitial-countdown-text {
        padding:8% 3% 0
    }
    ...
    .rotten-rotomatoes-fresh-icon {
        background:no-repeat url(//s.ytimg.com/yts/imgbin/www-hitchhiker-vfllYIUv0.png) -96px -474px;
        background-size:auto;
        width:13px;
        height:13px
    }
    .rotten-rotomatoes-splat-icon {
        background:no-repeat url(//s.ytimg.com/yts/imgbin/www-hitchhiker-vfllYIUv0.png) -149px -663px;
        background-size:auto;
        width:13px;
        height:13px
    }
    .rotten-rotomatoes-certified-icon {
        background:no-repeat url(//s.ytimg.com/yts/imgbin/www-hitchhiker-vfllYIUv0.png) -226px -775px;
        background-size:auto;
        width:13px;
        height:13px
    }
    ...
    .music-pass-icon {
        margin-top:3px;
        background:no-repeat url(//s.ytimg.com/yts/imgbin/www-hitchhiker-vfllYIUv0.png) -87px -218px;
        background-size:auto;
        width:13px;
        height:13px
    }
    ...
    .ytp-title-enable-channel-logo .html5-endscreen,.ytp-title-show-subtitle .html5-endscreen {
        margin-top:16px
    }
    .ytp-big-mode.ytp-title-enable-channel-logo .html5-endscreen,.ytp-big-mode.ytp-title-show-subtitle .html5-endscreen {
        margin-top:32px
    }
    ...
    .ytp-inline-subscribe-button-subscribe {
        display:flex;
        align-items:center
    }
    .ytp-inline-subscribe-button-unsubscribe,.ytp-inline-subscribe-button-subscribed .ytp-inline-subscribe-button-subscribe {
        display:none
    }
    .ytp-inline-subscribe-button-subscribed .ytp-inline-subscribe-button-unsubscribe {
        display:flex;
        align-items:center
    }
    ...
    .ytp-big-mode .ytp-inline-subscribe-button-text {
        font-size:20px
    }
    .ytp-inline-subscribe-button-subscribe .ytp-inline-subscribe-button-text {
        color:rgba(255,0,0,1)
    }
    .ytp-inline-subscribe-button-unsubscribe .ytp-inline-subscribe-button-text {
    ...
    .ytp-big-mode .ytp-inline-subscribe-button-icon {
        width:22px;
        height:26px;
        margin-right:8px
    }
    .ytp-inline-subscribe-button-subscribe .ytp-youtube-logo-bg {
        fill:rgba(255,0,0,1);
        fill-opacity:1
    }
    .ytp-inline-subscribe-button-unsubscribe .ytp-youtube-logo-bg {
    ...
    .ytp-player-minimized .ytp-storyboard {
    ...
    .ytp-player-minimized.ad-interrupting .ytp-miniplayer-ui .ytp-time-display {
        display:none
    }
    ...
    .ytp-player-minimized.ytp-menu-shown .videoAdUiPreSkipContainer,.ytp-player-minimized.ytp-menu-shown .videoAdUiSkipContainer {
        bottom:32px
    }
    ...
    .ytp-related-on-error-overlay.ytp-controls-on-error {
        bottom:36px
    }
    ...
    .ytp-title-top-right-subscribe {
        padding-top:12px
    }
    .ytp-big-mode .ytp-title-top-right-subscribe {
        padding-top:18px
    }
    .ytp-title-top-right-subscribe .ytp-button,.ytp-big-mode .ytp-title-top-right-subscribe .ytp-button {
        width:auto;
        height:auto;
        padding:0;
        vertical-align:middle
    }
    .ytp-title-top-right-subscribe .ytp-title-notifications {
        margin-left:6px
    }
    ...
    .ytp-big-mode .ytp-title-expanded {
        width:430px
    }
    .ytp-title-show-collapsed .ytp-title-expanded {
        opacity:0;
    ...
    .ytp-big-mode .ytp-title-show-collapsed .ytp-title-expanded {
    ...
    .ytp-title-show-expanded .ytp-title-expanded {
        opacity:1;
    ...
    .ytp-big-mode .ytp-title-show-expanded .ytp-title-expanded {
    ...
    .ytp-title-inline-subscribe,.ytp-title-inline-notify {
        display:none
    }
    .ytp-title-show-inline-subscribe .ytp-title-inline-subscribe,.ytp-title-show-inline-subscribe .ytp-title-inline-notify {
        display:inline
    }
    .ytp-chrome-top .ytp-title-inline-subscribe .ytp-inline-subscribe-button {
        height:auto;
        width:auto;
        padding:0
    }
    .ytp-title-inline-subscribe .ytp-inline-subscribe-button-subscribe {
        margin-right:12px
    }
    .ytp-big-mode .ytp-title-inline-subscribe .ytp-inline-subscribe-button-subscribe {
        margin-right:16px
    }
    .ytp-title-inline-subscribe .ytp-inline-subscribe-button-unsubscribe {
        margin-right:6px
    }
    .ytp-big-mode .ytp-title-inline-subscribe .ytp-inline-subscribe-button-unsubscribe {
        margin-right:8px
    }
    .ytp-chrome-top .ytp-title-inline-notify .ytp-title-notifications {
        height:auto;
        width:auto;
        padding-top:0
    }
    .ytp-title-inline-notify {
        margin-right:8px
    }
    .ytp-big-mode .ytp-title-inline-notify {
        margin-right:12px
    }
    .ytp-title-inline-notify svg {
        fill:rgba(155,155,155,1);
        width:16px;
        height:16px
    }
    .ytp-big-mode .ytp-title-inline-notify svg {
        width:22px;
        height:22px
    }
    ...
    .ytp-title-show-expanded .ytp-title-beacon,.ytp-title-show-expanded .ytp-title-text,.ytp-title-show-expanded .ytp-title-subtext {
        display:none
    }
    ...
    .ytp-title-show-collapsed .ytp-title-beacon,.ytp-title-show-expanded .ytp-title-beacon,.ytp-big-mode .ytp-title-beacon {
        display:none
    }
    .ytp-tooltip {
        position:absolute;
...
<html class="js touchevents cssanimations csspointerevents csstransforms supports csstransforms3d preserve3d csstransitions" lang="en-US"><head><link type="text/css" rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700"><style type="text/css">.gm-style .gm-style-cc span,.gm-style .gm-style-cc a,.gm-style .gm-style-mtc div{font-size:10px}
    </style><style type="text/css">@media print {  .gm-style .gmnoprint, .gmnoprint {    display:none  }}@media screen {  .gm-style .gmnoscreen, .gmnoscreen {    display:none  }}</style><style type="text/css">.gm-style-pbc{transition:opacity ease-in-out;background-color:rgba(0,0,0,0.45);text-align:center}.gm-style-pbt{font-size:22px;color:white;font-family:Roboto,Arial,sans-serif;position:relative;margin:0;top:50%;-webkit-transform:translateY(-50%);-ms-transform:translateY(-50%);transform:translateY(-50%)}
    </style>

    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Church | X Theme Demo</title>
    <link rel="pingback" href="http://demo.theme.co/church/xmlrpc.php"><meta name="robots" content="noindex,follow">
    <link rel="dns-prefetch" href="//s.w.org">
    <link rel="alternate" type="application/rss+xml" title="Church » Feed" href="http://demo.theme.co/church/feed/">
    <link rel="alternate" type="application/rss+xml" title="Church » Comments Feed" href="http://demo.theme.co/church/comments/feed/">
    <link rel="alternate" type="application/rss+xml" title="Church » Home Comments Feed" href="http://demo.theme.co/church/home/feed/">
    <script type="text/javascript">
        window._wpemojiSettings = {"baseUrl":"https:\/\/s.w.org\/images\/core\/emoji\/2.4\/72x72\/","ext":".png","svgUrl":"https:\/\/s.w.org\/images\/core\/emoji\/2.4\/svg\/","svgExt":".svg","source":{"concatemoji":"http:\/\/demo.theme.co\/church\/wp-includes\/js\/wp-emoji-release.min.js?ver=4.9.6"}};
    ...
    </script><script src="http://demo.theme.co/church/wp-includes/js/wp-emoji-release.min.js?ver=4.9.6" type="text/javascript" defer=""></script>
    <style type="text/css">
        img.wp-smiley,
        img.emoji {
            display: inline !important;
    ...
    <link rel="stylesheet" id="rs-plugin-settings-css" href="http://demo.theme.co/church/wp-content/plugins/revslider/public/assets/css/settings.css?ver=5.4.7.4" type="text/css" media="all">
    <style id="rs-plugin-settings-inline-css" type="text/css">
        #rs-demo-id {}
        .tp-caption.kb-medium,.kb-medium{font-size:26px;line-height:36px;font-weight:400;font-family:Montserrat;color:rgb(255,255,255);text-decoration:none;background-color:rgba(0,0,0,0);border-width:0px;border-color:rgb(255,214,88);border-style:none;text-transform:uppercase;letter-spacing:5px}.tp-caption.kclarge,.kclarge{font-size:46px;line-height:52px;font-weight:400;font-family:Montserrat;color:#ffffff;text-decoration:none;background-color:rgba(0,0,0,0);border-width:0px;border-color:rgb(255,214,88);border-style:none;text-transform:uppercase;letter-spacing:5px}	#rev_slider_1_1_wrapper .tp-loader.spinner3 div { background-color: #FFFFFF !important; } </style>
    <link rel="stylesheet" id="x-stack-css" href="http://demo.theme.co/church/wp-content/themes/x/framework/dist/css/site/stacks/renew.css?ver=6.1.1" type="text/css" media="all">
    <link rel="stylesheet" id="x-cranium-migration-css" href="http://demo.theme.co/church/wp-content/themes/x/framework/legacy/cranium/dist/css/site/renew.css?ver=6.1.1" type="text/css" media="all">
    <script type="text/javascript" src="/js/jquery/jquery.js?ver=1.12.4"></script>
    <script type="text/javascript" src="/js/jquery/jquery-migrate.min.js?ver=1.4.1"></script>
    <script type="text/javascript" src="/js/jquery.themepunch.tools.min.js?ver=5.4.7.4"></script>
    <script type="text/javascript" src="/js/jquery.themepunch.revolution.min.js?ver=5.4.7.4"></script>
    <script type="text/javascript" src="/js/site/cs-head.js?ver=3.1.1"></script>
<!--    <link rel="https://api.w.org/" href="http://demo.theme.co/church/wp-json/">-->
    <link rel="https://api.w.org/" src="/wp-json/">
    <link rel="canonical" href="http://demo.theme.co/church/">
    <link rel="shortlink" href="http://demo.theme.co/church/">
<!--    <link rel="alternate" type="application/json+oembed" href="http://demo.theme.co/church/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fdemo.theme.co%2Fchurch%2F">-->
    <link rel="alternate" type="application/json+oembed" href="/wp-json/oembed/1.0/embed?url=http%3A%2F%2Folqh%2F">
    <link rel="alternate" type="text/xml+oembed" href="http://demo.theme.co/church/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fdemo.theme.co%2Fchurch%2F&amp;format=xml">
...
<div id="x-root" class="x-root">
    ...
    <div id="top" class="site">
        ...
        <div class="x-slider-container above">
            ...
            <div class="forcefullwidth_wrapper_tp_banner" id="rev_slider_1_1_forcefullwidth" style="position:relative;width:100%;height:auto;margin-top:0px;margin-bottom:0px"><div id="rev_slider_1_1_wrapper" class="rev_slider_wrapper fullscreen-container tp-mouseover" data-source="gallery" style="background: rgb(67, 79, 91) none repeat scroll 0% 0%; padding: 0px; height: 323px; margin-top: 0px; margin-bottom: 0px; position: absolute; max-height: none; overflow: visible; width: 1353px; left: 0px;">
                    <!-- START REVOLUTION SLIDER 5.4.7.4 fullscreen mode -->
                    <div id="rev_slider_1_1" class="rev_slider fullscreenbanner revslider-initialised tp-simpleresponsive rev_redraw_on_blurfocus" style="max-height: none; margin-top: 0px; margin-bottom: 0px; height: 100%;" data-version="5.4.7.4" data-slideactive="rs-1">
                        <ul class="tp-revslider-mainul" style="visibility: visible; display: block; overflow: hidden; width: 100%; height: 100%; max-height: none;">	<!-- SLIDE  -->
                            <li data-index="rs-1" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="1000" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="" class="tp-revslider-slidesli active-revslide" style="width: 100%; height: 100%; overflow: hidden; z-index: 20; visibility: inherit; opacity: 1; background-color: rgba(255, 255, 255, 0);">
                                <!-- MAIN IMAGE -->
                                <div class="slotholder" style="position: absolute; top: 0px; left: 0px; z-index: 0; width: 100%; height: 100%; visibility: inherit; opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);"><!--Runtime Modification - Img tag is Still Available for SEO Goals in Source - <img src="http://demo.theme.co/church/wp-content/uploads/sites/63/revslider/church-home/bg-revslider-01.jpg" alt="" title="Home" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg defaultimg" data-no-retina="">--><div class="tp-bgimg defaultimg " data-bgcolor="undefined" style="background-repeat: no-repeat; background-image: url(&quot;http://demo.theme.co/church/wp-content/uploads/sites/63/revslider/church-home/bg-revslider-01.jpg&quot;); background-size: cover; background-position: center center; width: 100%; height: 100%; opacity: 1; visibility: inherit; z-index: 20;" src="http://demo.theme.co/church/wp-content/uploads/sites/63/revslider/church-home/bg-revslider-01.jpg"></div></div>
                                <!-- LAYERS -->

                                <!-- LAYER NR. 1 -->
                                <div class="tp-parallax-wrap" style="position: absolute; display: block; visibility: visible; left: 406px; top: 129px; z-index: 5;"><div class="tp-loop-wrap" style="position:absolute;display:block;;"><div class="tp-mask-wrap" style="position: absolute; display: block; overflow: visible;"><div class="tp-caption kb-medium   tp-resizeme" id="slide-1-layer-1" data-x="center" data-hoffset="0" data-y="center" data-voffset="-15" data-width="auto" data-height="auto" data-type="text" data-responsive_offset="on" data-frames="[{&quot;from&quot;:&quot;y:top;&quot;,&quot;speed&quot;:1500,&quot;to&quot;:&quot;&quot;,&quot;delay&quot;:500,&quot;ease&quot;:&quot;Power3.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:300,&quot;to&quot;:&quot;auto:auto;&quot;,&quot;ease&quot;:&quot;nothing&quot;}]" data-textalign="['','','','']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 5; white-space: nowrap; color: rgb(255, 255, 255); background-color: transparent; visibility: inherit; transition: none 0s ease 0s ; line-height: 35px; border-width: 0px; margin: 0px; padding: 0px; letter-spacing: 4px; font-weight: 400; font-size: 25px; min-height: 0px; min-width: 0px; max-height: none; max-width: none; opacity: 1; transform: translate3d(0px, 0px, 0px); transform-origin: 50% 50% 0px;">Welcome to Kingdom Church </div></div></div></div>

                                <!-- LAYER NR. 2 -->
                                <div class="tp-parallax-wrap" style="position: absolute; display: block; visibility: visible; left: 268px; top: 165px; z-index: 6;"><div class="tp-loop-wrap" style="position:absolute;display:block;;"><div class="tp-mask-wrap" style="position: absolute; display: block; overflow: visible;"><div class="tp-caption kclarge  " id="slide-1-layer-2" data-x="center" data-hoffset="0" data-y="center" data-voffset="30" data-width="auto" data-height="auto" data-type="text" data-responsive_offset="on" data-frames="[{&quot;from&quot;:&quot;y:bottom;&quot;,&quot;speed&quot;:1500,&quot;to&quot;:&quot;&quot;,&quot;delay&quot;:1000,&quot;ease&quot;:&quot;Power3.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:300,&quot;to&quot;:&quot;auto:auto;&quot;,&quot;ease&quot;:&quot;nothing&quot;}]" data-textalign="['','','','']" style="z-index: 6; white-space: nowrap; background-color: transparent; visibility: inherit; transition: none 0s ease 0s ; line-height: 51px; border-width: 0px; margin: 0px; padding: 0px; letter-spacing: 4px; font-weight: 400; font-size: 45px; min-height: 0px; min-width: 0px; max-height: none; max-width: none; opacity: 1; transform: translate3d(0px, 0px, 0px); transform-origin: 50% 50% 0px;">Loving God. Loving People. </div></div></div></div>

                                <!-- LAYER NR. 3 -->
                                <div class="tp-parallax-wrap" style="position: absolute; display: block; visibility: visible; left: 639px; top: 19px; z-index: 7;"><div class="tp-loop-wrap" style="position:absolute;display:block;;"><div class="tp-mask-wrap" style="position: absolute; display: block; overflow: visible;"><div class="tp-caption   tp-resizeme" id="slide-1-layer-3" data-x="center" data-hoffset="0" data-y="20" data-width="" data-height="" data-type="image" data-responsive_offset="on" data-frames="[{&quot;from&quot;:&quot;y:top;&quot;,&quot;speed&quot;:1500,&quot;to&quot;:&quot;&quot;,&quot;delay&quot;:1500,&quot;ease&quot;:&quot;Power3.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:300,&quot;to&quot;:&quot;auto:auto;&quot;,&quot;ease&quot;:&quot;nothing&quot;}]" data-textalign="['','','','']" style="z-index: 7; visibility: inherit; transition: none 0s ease 0s ; line-height: 0px; border-width: 0px; margin: 0px; padding: 0px; letter-spacing: 0px; font-weight: 400; font-size: 16px; white-space: nowrap; opacity: 1; transform: translate3d(0px, 0px, 0px); transform-origin: 50% 50% 0px;"><img src="http://demo.theme.co/church/wp-content/uploads/sites/63/revslider/church-home/revslider-01.png" alt="" data-no-retina="" style="width: 75.3667px; height: 70.4727px; transition: none 0s ease 0s ; line-height: 0px; border-width: 0px; margin: 0px; padding: 0px; letter-spacing: 0px; font-weight: 400; font-size: 16px;" width="77" height="72"> </div></div></div></div>
                            </li>
                        </ul>
                        <div class="tp-bannertimer tp-bottom" style="visibility: hidden ! important; width: 0%;"></div>	<div class="tp-loader spinner3" style="display: none;"><div class="dot1"></div><div class="dot2"></div><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div>
                    <script>var htmlDiv = document.getElementById("rs-plugin-settings-inline-css"); var htmlDivCss=".tp-caption.kb-medium,.kb-medium{font-size:26px;line-height:36px;font-weight:400;font-family:Montserrat;color:rgb(255,255,255);text-decoration:none;background-color:rgba(0,0,0,0);border-width:0px;border-color:rgb(255,214,88);border-style:none;text-transform:uppercase;letter-spacing:5px}.tp-caption.kclarge,.kclarge{font-size:46px;line-height:52px;font-weight:400;font-family:Montserrat;color:#ffffff;text-decoration:none;background-color:rgba(0,0,0,0);border-width:0px;border-color:rgb(255,214,88);border-style:none;text-transform:uppercase;letter-spacing:5px}";
                        if(htmlDiv) {
                    ...
                    <script type="text/javascript">
                        if (setREVStartSize!==undefined) setREVStartSize(
                            {c: '#rev_slider_1_1', gridwidth: [960], gridheight: [330], sliderLayout: 'fullscreen', fullScreenAutoWidth:'off', fullScreenAlignForce:'off', fullScreenOffsetContainer:'', fullScreenOffset:''});
                            ...
                            function onLoad() {
                                ...
                                if(tpj("#rev_slider_1_1").revolution == undefined){
                                    ...
                                    revapi1 = tpj("#rev_slider_1_1").show().revolution({
                                        sliderType:"standard",
                                        jsFileLocation:"//demo.theme.co/church/wp-content/plugins/revslider/public/assets/js/",
                ...
                </div><div class="tp-fullwidth-forcer" style="width: 100%; height: 323px;"></div></div><!-- END REVOLUTION SLIDER -->
        </div>
        ...
        <header class="masthead masthead-inline" role="banner">
            ...
            <div class="x-topbar">
                <div class="x-topbar-inner x-container max width">
                    <p class="p-info">Join us on Sundays at 10am and 1pm | Wednesdays at 7pm</p>
                    <div class="x-social-global"><a href="#" class="facebook" title="Facebook" target="_blank"><i class="x-icon-facebook-square" data-x-icon="" aria-hidden="true"></i></a><a href="#" class="twitter" title="Twitter" target="_blank"><i class="x-icon-twitter-square" data-x-icon="" aria-hidden="true"></i></a><a href="#" class="instagram" title="Instagram" target="_blank"><i class="x-icon-instagram" data-x-icon="" aria-hidden="true"></i></a></div>    </div>
            </div>
                ...
                <div class="x-navbar">
                    <div class="x-navbar-inner">
                        <div class="x-container max width">
                            ...
                            <h1 class="visually-hidden">Church</h1>
                            <a href="http://demo.theme.co/church/" class="x-brand img" title="X Theme Demo">
                                <img src="//demo.theme.co/church/wp-content/uploads/sites/63/2016/06/logo.png" alt="X Theme Demo"></a>
                            ...
                            <nav class="x-nav-wrap desktop" role="navigation">
                                <ul id="menu-primary-menu" class="x-nav"><li id="menu-item-550" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-8 current_page_item menu-item-550"><a href="http://demo.theme.co/church/"><span>Home</span></a></li>
                                    <li id="menu-item-551" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-551"><a href="http://demo.theme.co/church/about/"><span>About</span></a></li>
                                    <li id="menu-item-552" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-552"><a href="http://demo.theme.co/church/ministries/"><span>Ministries</span></a>
                                        <ul class="sub-menu">
                                            <li id="menu-item-553" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-553"><a href="http://demo.theme.co/church/ministries/kidzone/"><span>Kidzone</span></a></li>
                                            <li id="menu-item-511" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-511"><a href="#"><span>Life</span></a></li>
                                            <li id="menu-item-548" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-548"><a href="#"><span>Summit</span></a></li>
                                            <li id="menu-item-549" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-549"><a href="#"><span>Adored</span></a></li>
                                        </ul>
                                    </li>
                                    <li id="menu-item-505" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-505 tax-item tax-item-4"><a href="http://demo.theme.co/church/category/sermons/"><span>Sermons</span></a></li>
                                    <li id="menu-item-504" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-504 tax-item tax-item-3"><a href="http://demo.theme.co/church/category/news/"><span>News</span></a></li>
                                    <li id="menu-item-509" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-509 tax-item tax-item-2"><a href="http://demo.theme.co/church/category/events/"><span>Events</span></a></li>
                                    <li class="menu-item x-menu-item x-menu-item-search"><a href="#" class="x-btn-navbar-search"><span><i class="x-icon-search" data-x-icon="" aria-hidden="true"></i><span class="x-hidden-desktop"> Search</span></span></a></li></ul></nav>

                            <div id="x-nav-wrap-mobile" class="x-nav-wrap mobile x-collapsed" data-x-toggleable="x-nav-wrap-mobile" data-x-toggle-collapse="1" aria-hidden="true" aria-labelledby="x-btn-navbar">
                                <ul id="menu-primary-menu-1" class="x-nav"><li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-8 current_page_item menu-item-550"><a href="http://demo.theme.co/church/"><span>Home</span></a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-551"><a href="http://demo.theme.co/church/about/"><span>About</span></a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-552"><a href="http://demo.theme.co/church/ministries/"><span>Ministries</span><div class="x-sub-toggle collapsed" data-x-toggle="collapse-b" data-x-toggleable="x-nav-wrap-mobile-sm-0" aria-expanded="false" aria-haspopup="true" aria-controls="x-nav-wrap-mobile-sm-0"><span><i class="x-icon-angle-double-down" data-x-icon=""></i></span></div></a>
                                        <ul class="x-collapsed" id="x-nav-wrap-mobile-sm-0" data-x-toggleable="x-nav-wrap-mobile-sm-0" data-x-toggle-collapse="1" aria-hidden="true">
                                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-553"><a href="http://demo.theme.co/church/ministries/kidzone/"><span>Kidzone</span></a></li>
                                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-511"><a href="#"><span>Life</span></a></li>
                                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-548"><a href="#"><span>Summit</span></a></li>
                                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-549"><a href="#"><span>Adored</span></a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-505 tax-item tax-item-4"><a href="http://demo.theme.co/church/category/sermons/"><span>Sermons</span></a></li>
                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-504 tax-item tax-item-3"><a href="http://demo.theme.co/church/category/news/"><span>News</span></a></li>
                                    <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-509 tax-item tax-item-2"><a href="http://demo.theme.co/church/category/events/"><span>Events</span></a></li>
        ...
        <div class="x-main full" role="main">
            ...
            <article id="post-8" class="post-8 page type-page status-publish hentry no-post-thumbnail">
                ...
                <div class="entry-content content">
                    ...
                    <div id="cs-content" class="cs-content"><div id="x-section-1" class="x-section cs-ta-center bg-image" style="margin: 0px;padding: 9% 3%; background-image: url(http://demo.theme.co/church/wp-content/uploads/sites/63/2015/08/bg-city-tan.jpg); background-color: #e4e1d0;" data-x-element="section" data-x-params="{&quot;type&quot;:&quot;image&quot;,&quot;parallax&quot;:false}"><div class="x-container max width" style="margin: 0px auto;padding: 0px;"><div class="x-column x-sm x-1-1" style="padding: 0px;"><h2 class="h-custom-headline man h-intro h3" style="font-size: 48px;"><span>Welcome to Kingdom Church</span></h2><div class="x-raw-content p-intro" style="max-width: 800px; margin: 0.925em auto 1.25em; color: rgb(67, 79, 91); font-size: 21px;"><p class="man">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque pretium, nisi ut volutpat mollis, leo risus interdum arcu, eget facilisis quam felis id mauris. Ut convallis, lacus nec ornare volutpat, velit turpis scelerisque purus, quis mollis velit purus ac massa. Fusce quis urna metus. Donec et lacus et sem lacinia cursus.</p></div><a class="x-btn x-btn-alt-dark x-btn-x-large" href="//theme.co/x/demo/expanded/church/about/" title="Learn More" data-options="thumbnail: ''">Learn More</a></div></div></div><div id="x-section-2" class="x-section" style="margin: 0px;padding: 9% 3%; background-color: transparent;"><div class="x-container max width" style="margin: 0px auto;padding: 0px;"><div class="x-column x-sm x-1-3" style="padding: 0px;"><h2 class="h-custom-headline man h4"><span>Events</span></h2><div class="x-raw-content" style="margin: 0.75em 0 1.25em;"><p class="man">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque pretium, nisi ut volutpat mollis.</p></div><a class="x-btn x-btn-regular" href="//theme.co/x/demo/expanded/church/category/events/" title="All Events" data-options="thumbnail: ''">All Events</a><hr class="x-gap cs-hide-xl cs-hide-lg cs-hide-md" style="margin: 9% 0 0 0;"></div><div class="x-column x-sm x-2-3" style="padding: 0px;"><div class="x-recent-posts cf man horizontal" data-x-element="recent_posts" data-x-params="{&quot;fade&quot;:false}" data-fade="false"><a class="x-recent-post2 with-image" href="http://demo.theme.co/church/easter-week/" title="Permalink to: &quot;Easter Week&quot;"><article id="post-425" class="post-425 post type-post status-publish format-standard has-post-thumbnail hentry category-events no-post-thumbnail"><div class="entry-wrap"><div class="x-recent-posts-img" style="background-image: url(http://demo.theme.co/church/wp-content/uploads/sites/63/2015/08/featured-events-03-862x482.jpg);"></div><div class="x-recent-posts-content"><h3 class="h-recent-posts">Easter Week</h3><span class="x-recent-posts-date">April 5, 2015</span></div></div></article></a><a class="x-recent-post2 with-image" href="http://demo.theme.co/church/couples-retreat/" title="Permalink to: &quot;Couples Retreat&quot;"><article id="post-432" class="post-432 post type-post status-publish format-standard has-post-thumbnail hentry category-events no-post-thumbnail"><div class="entry-wrap"><div class="x-recent-posts-img" style="background-image: url(http://demo.theme.co/church/wp-content/uploads/sites/63/2015/08/featured-events-02-862x482.jpg);"></div><div class="x-recent-posts-content"><h3 class="h-recent-posts">Couples Retreat</h3><span class="x-recent-posts-date">February 12, 2015</span></div></div></article></a></div></div></div></div><div id="x-section-3" class="x-section bg-image parallax" style="margin: 0px; padding: 0px; background-image: url(&quot;http://demo.theme.co/church/wp-content/uploads/sites/63/2015/08/bg-band-teal.jpg&quot;); background-color: rgb(97, 144, 162); background-attachment: scroll;" data-x-element="section" data-x-params="{&quot;type&quot;:&quot;image&quot;,&quot;parallax&quot;:true}"><div class="x-container marginless-columns" style="margin: 0px auto;padding: 0px;"><div class="x-column x-sm cs-ta-center x-1-2" style="padding: 6.5%;vertical-align: middle;"><h2 class="h-custom-headline man h4" style="color: #e4e1d0;"><span>Our Mission</span></h2><div class="x-raw-content mts" style="color: #fff;"><p class="man">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque pretium, nisi ut volutpat mollis.</p></div></div><div class="x-column x-sm x-1-2" style="padding: 0px;vertical-align: middle;"><div class="x-video embed man"><div class="x-video-inner"><iframe src="https://www.youtube.com/embed/yGNznfexvUA?rel=0&amp;controls=0&amp;showinfo=0&amp;wmode=transparent" allowfullscreen="" wmode="Opaque" frameborder="0" width="560" height="315"></iframe></div></div></div></div></div><div id="x-section-4" class="x-section" style="margin: 0px;padding: 50px 0px; background-color: transparent;"><div class="x-container max width" style="margin: 0px auto;padding: 0px;"><div class="x-column x-sm x-1-5" style="padding: 0px;"><div class="x-counter" data-x-element="counter" data-x-params="{&quot;numEnd&quot;:217,&quot;numSpeed&quot;:1500}"><div class="number-wrap w-h" style="color: #434f5b;"><span class="number">0</span></div><span class="text-below">Members</span></div><hr class="x-gap cs-hide-xl cs-hide-lg cs-hide-md" style="margin: 25px 0 0 0;"></div><div class="x-column x-sm x-1-5" style="padding: 0px;"><div class="x-counter" data-x-element="counter" data-x-params="{&quot;numEnd&quot;:45,&quot;numSpeed&quot;:1500}"><div class="number-wrap w-h" style="color: #434f5b;"><span class="number">0</span></div><span class="text-below">Volunteers</span></div><hr class="x-gap cs-hide-xl cs-hide-lg cs-hide-md" style="margin: 25px 0 0 0;"></div><div class="x-column x-sm x-1-5" style="padding: 0px;"><div class="x-counter" data-x-element="counter" data-x-params="{&quot;numEnd&quot;:11,&quot;numSpeed&quot;:1500}"><div class="number-wrap w-h" style="color: #434f5b;"><span class="number">0</span></div><span class="text-below">Groups</span></div><hr class="x-gap cs-hide-xl cs-hide-lg cs-hide-md" style="margin: 25px 0 0 0;"></div><div class="x-column x-sm x-1-5" style="padding: 0px;"><div class="x-counter" data-x-element="counter" data-x-params="{&quot;numEnd&quot;:3,&quot;numSpeed&quot;:1500}"><div class="number-wrap w-h" style="color: #434f5b;"><span class="number">0</span></div><span class="text-below">Services</span></div><hr class="x-gap cs-hide-xl cs-hide-lg cs-hide-md" style="margin: 25px 0 0 0;"></div><div class="x-column x-sm x-1-5" style="padding: 0px;"><div class="x-counter" data-x-element="counter" data-x-params="{&quot;numEnd&quot;:1,&quot;numSpeed&quot;:1500}"><div class="number-wrap w-h" style="color: #434f5b;"><span class="number">0</span></div><span class="text-below">Purpose</span></div></div></div></div><div id="x-section-5" class="x-section cs-ta-center" style="margin: 0px;padding: 9% 3%; background-color: #434f5b;"><div class="x-container max width" style="margin: 0px auto;padding: 0px;"><div class="x-column x-sm x-1-1" style="padding: 0px;"><h2 class="h-custom-headline man h3" style="color: #e4e1d0;"><span>Worship With Us</span></h2></div></div><div class="x-container max width" style="margin: 40px auto 0px;padding: 0px;"><div class="x-column x-sm x-1-3" style="padding: 0px;"><h3 class="h-custom-headline man h4" style="color: #e4e1d0;"><span><i class="x-icon x-icon-calendar-o" style="text-align: center;      color: rgba(255, 255, 255, 0.65);" data-x-icon="" aria-hidden="true"></i> When</span></h3><div class="x-raw-content mtm" style="color: rgba(255, 255, 255, 0.65);"><p class="man">Sundays at <strong>10am</strong> and <strong>1pm</strong><br>Wednesdays at <strong>7pm</strong></p></div><hr class="x-gap cs-hide-xl cs-hide-lg cs-hide-md" style="margin: 40px 0 0 0;"></div><div class="x-column x-sm x-1-3" style="padding: 0px;"><h3 class="h-custom-headline man h4" style="color: #e4e1d0;"><span><i class="x-icon x-icon-map-marker" style="text-align: center;      color: rgba(255, 255, 255, 0.65);" data-x-icon="" aria-hidden="true"></i> Where</span></h3><div class="x-raw-content mtm" style="color: rgba(255, 255, 255, 0.65);"><p class="man"><strong>123 Imaginary Drive</strong><br>New York, New York</p></div><hr class="x-gap cs-hide-xl cs-hide-lg cs-hide-md" style="margin: 40px 0 0 0;"></div><div class="x-column x-sm x-1-3" style="padding: 0px;"><h3 class="h-custom-headline man h4" style="color: #e4e1d0;"><span><i class="x-icon x-icon-thumbs-up" style="text-align: center;      color: rgba(255, 255, 255, 0.65);" data-x-icon="" aria-hidden="true"></i> How</span></h3><div class="x-raw-content mtm" style="color: rgba(255, 255, 255, 0.65);"><p class="man"><strong>Fun</strong> and <strong>casual</strong> for<br>all ages and families</p></div></div></div></div><div id="x-section-6" class="x-section" style="margin: 0px;padding: 0px; background-color: transparent;"><div class="x-container" style="margin: 0px auto;padding: 0px;"><div class="x-column x-sm x-1-1" style="padding: 0px;"><div id="x-google-map-1" class="x-map x-google-map man" data-x-element="google_map" data-x-params="{&quot;lat&quot;:&quot;40.7056308&quot;,&quot;lng&quot;:&quot;-73.9780035&quot;,&quot;drag&quot;:false,&quot;zoom&quot;:&quot;12&quot;,&quot;zoomControl&quot;:false,&quot;hue&quot;:&quot;&quot;}"><div class="x-map-inner x-google-map-inner" style="padding-bottom: 35%; position: relative; overflow: hidden;"><div style="height: 100%; width: 100%; position: absolute; top: 0px; left: 0px; background-color: rgb(229, 227, 223);"><div style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px;" class="gm-style"><div style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px; cursor: url(&quot;https://maps.gstatic.com/mapfiles/openhand_8_8.cur&quot;), default;" tabindex="0"><div style="z-index: 1; position: absolute; left: 50%; top: 50%; transform: translate(0px, 0px);"><div style="position: absolute; left: 0px; top: 0px; z-index: 100; width: 100%;"><div style="position: absolute; left: 0px; top: 0px; z-index: 0;"><div style="position: absolute; z-index: 1; transform: matrix(1, 0, 0, 1, -75, -32);"><div style="position: absolute; left: 0px; top: 0px; width: 256px; height: 256px;"><div style="width: 256px; height: 256px;"></div></div><div style="position: absolute; left: -256px; top: 0px; width: 
; z-index: 105; width: 100%;"></div><div style="position: absolute; left: 0px; top: 0px; z-index: 106; width: 100%;"><div style="width: 43px; height: 59px; overflow: hidden; position: absolute; opacity: 0.01; cursor: pointer; left: -22px; top: -51px; z-index: 0;" class="gmnoprint" title=""><img style="position: absolute; left: 0px; top: 0px; width: 43px; height: 59px; -moz-user-select: none; border: 0px none; padding: 0px; margin: 0px; max-width: none;" alt="" src="https://maps.gstatic.com/mapfiles/api-3/images/spotlight-poi2.png" draggable="false"></div></div><div style="position: absolute; left: 0px; top: 0px; z-index: 107; width: 100%;"></div></div></div></div><iframe style="z-index: -1; position: absolute; width: 100%; height: 100%; top: 0px; left: 0px; border: medium none;" src="about:blank" frameborder="0"></iframe><div style="margin-left: 5px; margin-right: 5px; z-index: 1000000; position: absolute; left: 0px; bottom: 0px;"><a style="position: static; overflow: visible; float: none; display: inline;" target="_blank" href="https://maps.google.com/maps?ll=40.705631,-73.978003&amp;z=12&amp;hl=en-US&amp;gl=US&amp;mapclient=apiv3" title="Click to see this area on Google Maps"><div style="width: 66px; height: 26px; cursor: pointer;"><img style="position: absolute; left: 0px; top: 0px; width: 66px; height: 26px; -moz-user-select: none; border: 0px none; padding: 0px; margin: 0px;" alt="" src="https://maps.gstatic.com/mapfiles/api-3/images/google_white5.png" draggable="false"></div></a></div><div style="background-color: white; padding: 15px 21px; border: 1px solid rgb(171, 171, 171); font-family: Roboto,Arial,sans-serif; color: rgb(34, 34, 34); box-shadow: 0px 4px 16px rgba(0, 0, 0, 0.2); z-index: 10000002; display: none; width: 256px; height: 148px; position: absolute; left: 527px; top: 147px;"><div style="padding: 0px 0px 10px; font-size: 16px;">Map Data</div><div style="font-size: 13px;">Map data ©2018 Google</div><div style="width: 13px; height: 13px; overflow: hidden; position: absolute; opacity: 0.7; right: 12px; top: 12px; z-index: 10000;"><img style="position: absolute; left: -2px; top: -336px; width: 59px; height: 492px; -moz-user-select: none; border: 0px none; padding: 0px; margin: 0px; max-width: none;" alt="" src="https://maps.gstatic.com/mapfiles/api-3/images/mapcnt6.png" draggable="false"></div><img style="width: 37px; height: 37px; -moz-user-select: none; border: 0px none; padding: 0px; margin: 0px; position: absolute; right: 0px; top: 0px; z-index: 10001; cursor: pointer;" alt="" src="https://maps.gstatic.com/mapfiles/transparent.png" draggable="false"></div><div class="gmnoprint" style="z-index: 1000001; position: absolute; right: 69px; bottom: 0px; width: 121px;"><div draggable="false" style="-moz-user-select: none; height: 14px; line-height: 14px;" class="gm-style-cc"><div style="opacity: 0.7; width: 100%; height: 100%; position: absolute;"><div style="width: 1px;"></div><div style="background-color: rgb(245, 245, 245); width: auto; height: 100%; margin-left: 1px;"></div></div><div style="position: relative; padding-right: 6px; padding-left: 6px; font-family: Roboto,Arial,sans-serif; font-size: 10px; color: rgb(68, 68, 68); white-space: nowrap; direction: ltr; text-align: right; vertical-align: middle; display: inline-block;"><a style="text-decoration: none; cursor: pointer; display: none;">Map Data</a><span>Map data ©2018 Google</span></div></div></div><div class="gmnoscreen" style="position: absolute; right: 0px; bottom: 0px;"><div style="font-family: Roboto,Arial,sans-serif; font-size: 11px; color: rgb(68, 68, 68); direction: ltr; text-align: right; background-color: rgb(245, 245, 245);">Map data ©2018 Google</div></div><div class="gmnoprint gm-style-cc" style="z-index: 1000001; -moz-user-select: none; height: 14px; line-height: 14px; position: absolute; right: 0px; bottom: 0px;" draggable="false"><div style="opacity: 0.7; width: 100%; height: 100%; position: absolute;"><div style="width: 1px;"></div><div style="background-color: rgb(245, 245, 245); width: auto; height: 100%; margin-left: 1px;"></div></div><div style="position: relative; padding-right: 6px; padding-left: 6px; font-family: Roboto,Arial,sans-serif; font-size: 10px; color: rgb(68, 68, 68); white-space: nowrap; direction: ltr; text-align: right; vertical-align: middle; display: inline-block;"><a style="text-decoration: none; cursor: pointer; color: rgb(68, 68, 68);" href="https://www.google.com/intl/en-US_US/help/terms_maps.html" target="_blank">Terms of Use</a></div></div><button style="background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; margin: 10px 14px; padding: 0px; position: absolute; cursor: pointer; -moz-user-select: none; width: 25px; height: 25px; overflow: hidden; display: none; top: 0px; right: 0px;" draggable="false" title="Toggle fullscreen view" aria-label="Toggle fullscreen view" type="button"><img style="position: absolute; left: -52px; top: -86px; width: 164px; height: 175px; -moz-user-select: none; border: 0px none; padding: 0px; margin: 0px;" alt="" src="https://maps.gstatic.com/mapfiles/api-3/images/sv9.png" draggable="false" class="gm-fullscreen-control"></button></div></div></div><div class="x-google-map-marker" style="position: absolute; visibility: hidden;" data-x-element="google_map_marker" data-x-params="{&quot;lat&quot;:&quot;40.7056308&quot;,&quot;lng&quot;:&quot;-73.9780035&quot;,&quot;markerInfo&quot;:&quot;&quot;,&quot;startOpen&quot;:false}"></div></div></div></div></div><div id="x-section-7" class="x-section" style="margin: 0px;padding: 9% 3%; background-color: transparent;"><div class="x-container max width" style="margin: 0px auto;padding: 0px;"><div class="x-column x-sm x-1-3" style="padding: 0px;"><h2 class="h-custom-headline man h4"><span>Sermons</span></h2><div class="x-raw-content" style="margin: 0.75em 0 1.25em;"><p class="man">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque pretium, nisi ut volutpat mollis.</p></div><a class="x-btn x-btn-regular" href="//theme.co/x/demo/expanded/church/category/sermons/" title="All Sermons" data-options="thumbnail: ''">All Sermons</a><hr class="x-gap cs-hide-xl cs-hide-lg cs-hide-md" style="margin: 9% 0 0 0;"></div><div class="x-column x-sm x-2-3" style="padding: 0px;"><div class="x-recent-posts cf man horizontal" data-x-element="recent_posts" data-x-params="{&quot;fade&quot;:false}" data-fade="false"><a class="x-recent-post2 with-image" href="http://demo.theme.co/church/walk-on-water/" title="Permalink to: &quot;Walk on Water&quot;"><article id="post-139" class="post-139 post type-post status-publish format-audio has-post-thumbnail hentry category-sermons post_format-post-format-audio no-post-thumbnail"><div class="entry-wrap"><div class="x-recent-posts-img" style="background-image: url(http://demo.theme.co/church/wp-content/uploads/sites/63/2015/08/featured-sermons-05-862x482.jpg);"></div><div class="x-recent-posts-content"><h3 class="h-recent-posts">Walk on Water</h3><span class="x-recent-posts-date">March 8, 2015</span></div></div></article></a><a class="x-recent-post2 with-image" href="http://demo.theme.co/church/staying-focused/" title="Permalink to: &quot;Staying Focused&quot;"><article id="post-135" class="post-135 post type-post status-publish format-audio has-post-thumbnail hentry category-sermons post_format-post-format-audio no-post-thumbnail"><div class="entry-wrap"><div class="x-recent-posts-img" style="background-image: url(http://demo.theme.co/church/wp-content/uploads/sites/63/2015/08/featured-sermons-03-862x482.jpg);"></div><div class="x-recent-posts-content"><h3 class="h-recent-posts">Staying Focused</h3><span class="x-recent-posts-date">March 1, 2015</span></div></div></article></a></div></div></div></div><div id="x-section-8" class="x-section cs-ta-center bg-image" style="margin: 0px;padding: 9% 3%; background-image: url(http://demo.theme.co/church/wp-content/uploads/sites/63/2015/08/bg-bible-teal.jpg); background-color: #6190a2;" data-x-element="section" data-x-params="{&quot;type&quot;:&quot;image&quot;,&quot;parallax&quot;:false}"><div class="x-container max width" style="margin: 0px auto;padding: 0px;"><div class="x-column x-sm x-1-1" style="padding: 0px;"><h4 class="h-custom-headline mtn mbs h-verse h3" style="line-height: 1.4; color: rgb(228, 225, 208); font-size: 36px;"><span>Seek the kingdom of God above all else, and live righteously, and he will give you everything you need.</span></h4><div class="x-raw-content" style="font-size: 1.25em;color: #e4e1d0;"><p class="man">Matthew 6:33</p></div></div></div></div><div id="x-section-9" class="x-section cs-ta-center" style="margin: 0px;padding: 9% 3%; background-color: #e4e1d0;"><div class="x-container max width" style="margin: 0px auto;padding: 0px;"><div class="x-column x-sm x-1-1" style="padding: 0px;"><h2 class="h-custom-headline man h3"><span>Latest News</span></h2><div class="x-recent-posts cf vertical" style="max-width: 500px;margin: 2em auto;" data-x-element="recent_posts" data-x-params="{&quot;fade&quot;:false}" data-fade="false"><a class="x-recent-post4 no-image" href="http://demo.theme.co/church/navigating-life-when-things-get-hard/" title="Permalink to: &quot;Navigating Life When Things Get Hard&quot;"><article id="post-95" class="post-95 post type-post status-publish format-standard has-post-thumbnail hentry category-news no-post-thumbnail"><div class="entry-wrap"><div class="x-recent-posts-content"><h3 class="h-recent-posts">Navigating Life When Things Get Hard</h3><span class="x-recent-posts-date">May 27, 2015</span></div></div></article></a><a class="x-recent-post4 no-image" href="http://demo.theme.co/church/my-life-my-job-and-my-career/" title="Permalink to: &quot;My Life, My Job, and My Career&quot;"><article id="post-97" class="post-97 post type-post status-publish format-standard has-post-thumbnail hentry category-news no-post-thumbnail"><div class="entry-wrap"><div class="x-recent-posts-content"><h3 class="h-recent-posts">My Life, My Job, and My Career</h3><span class="x-recent-posts-date">February 27, 2015</span></div></div></article></a><a class="x-recent-post4 no-image" href="http://demo.theme.co/church/celebrating-a-life-well-lived/" title="Permalink to: &quot;Celebrating a Life Well Lived&quot;"><article id="post-93" class="post-93 post type-post status-publish format-standard has-post-thumbnail hentry category-news no-post-thumbnail"><div class="entry-wrap"><div class="x-recent-posts-content"><h3 class="h-recent-posts">Celebrating a Life Well Lived</h3><span class="x-recent-posts-date">February 17, 2015</span></div></div></article></a><a class="x-recent-post4 no-image" href="http://demo.theme.co/church/heres-to-a-great-2015/" title="Permalink to: &quot;Here’s to a Great 2015&quot;"><article id="post-89" class="post-89 post type-post status-publish format-standard has-post-thumbnail hentry category-news no-post-thumbnail"><div class="entry-wrap"><div class="x-recent-posts-content"><h3 class="h-recent-posts">Here’s to a Great 2015</h3><span class="x-recent-posts-date">December 31, 2014</span></div></div></article></a></div><a class="x-btn x-btn-regular" href="//theme.co/x/demo/expanded/church/category/news/" title="All News" data-options="thumbnail: ''">All News</a></div></div></div><div id="x-section-10" class="x-section" style="margin: 0px;padding: 9% 0px; background-color: transparent;"><div class="x-container max width" style="margin: 0px auto;padding: 0px;"><div class="x-column x-sm x-1-1" style="padding: 0px;"><h2 class="h-custom-headline cs-ta-center man h3"><span>Get Connected</span></h2></div></div><div class="x-container max width" style="margin: 40px auto 0px;padding: 0px;"><div class="x-column x-sm x-1-4" style="padding: 0px;"><div class="x-promo promo-custom"><div class="x-promo-image-wrap"><img src="http://demo.theme.co/church/wp-content/uploads/sites/63/2015/08/ministry-kids.jpg" alt="Children's Ministry"></div><div class="x-promo-content">
                                            <h4>Kids</h4>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque pretium, nisi ut volutpat mollis, leo risus.</p>
                                            <a class="x-btn x-btn-small" href="//theme.co/x/demo/expanded/church/ministries/kidzone/" title="More" data-options="thumbnail: ''">More →</a></div></div><hr class="x-gap cs-hide-xl cs-hide-md cs-hide-lg" style="margin: 40px 0 0 0;"></div><div class="x-column x-sm x-1-4" style="padding: 0px;"><div class="x-promo promo-custom"><div class="x-promo-image-wrap"><img src="http://demo.theme.co/church/wp-content/uploads/sites/63/2015/08/ministry-youth.jpg" alt="Youth Ministry"></div><div class="x-promo-content">
                                            <h4>Youth</h4>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque pretium, nisi ut volutpat mollis, leo risus.</p>
                                            <a class="x-btn x-btn-small" href="#" title="More" data-options="thumbnail: ''">More →</a></div></div><hr class="x-gap cs-hide-xl cs-hide-lg cs-hide-md" style="margin: 40px 0 0 0;"></div><div class="x-column x-sm x-1-4" style="padding: 0px;"><div class="x-promo promo-custom"><div class="x-promo-image-wrap"><img src="http://demo.theme.co/church/wp-content/uploads/sites/63/2015/08/ministry-men.jpg" alt="Men's Ministry"></div><div class="x-promo-content">
                                            <h4>Men</h4>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque pretium, nisi ut volutpat mollis, leo risus.</p>
                                            <a class="x-btn x-btn-small" href="#" title="More" data-options="thumbnail: ''">More →</a></div></div><hr class="x-gap cs-hide-md cs-hide-lg cs-hide-xl" style="margin: 40px 0 0 0;"></div><div class="x-column x-sm x-1-4" style="padding: 0px;"><div class="x-promo promo-custom"><div class="x-promo-image-wrap"><img src="http://demo.theme.co/church/wp-content/uploads/sites/63/2015/08/ministry-women.jpg" alt="Women's Ministry"></div><div class="x-promo-content">
                                            <h4>Women</h4>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque pretium, nisi ut volutpat mollis, leo risus.</p>
                                            <a class="x-btn x-btn-small" href="#" title="More" data-options="thumbnail: ''">More →</a></div></div></div></div></div><span id="x-responsive-text-1" data-x-element="responsive_text" data-x-params="{&quot;selector&quot;:&quot;.h-intro&quot;,&quot;compression&quot;:&quot;1.15&quot;,&quot;minFontSize&quot;:&quot;32px&quot;,&quot;maxFontSize&quot;:&quot;48px&quot;}"></span><span id="x-responsive-text-2" data-x-element="responsive_text" data-x-params="{&quot;selector&quot;:&quot;.p-intro&quot;,&quot;compression&quot;:&quot;2.65&quot;,&quot;minFontSize&quot;:&quot;16px&quot;,&quot;maxFontSize&quot;:&quot;21px&quot;}"></span><span id="x-responsive-text-3" data-x-element="responsive_text" data-x-params="{&quot;selector&quot;:&quot;.h-verse&quot;,&quot;compression&quot;:&quot;1.15&quot;,&quot;minFontSize&quot;:&quot;24px&quot;,&quot;maxFontSize&quot;:&quot;36px&quot;}"></span></div>
        ...
        <footer class="x-colophon bottom" role="contentinfo">
            <div class="x-container max width">
                ...
                <div class="x-social-global"><a href="#" class="facebook" title="Facebook" target="_blank"><i class="x-icon-facebook-square" data-x-icon="" aria-hidden="true"></i></a><a href="#" class="twitter" title="Twitter" target="_blank"><i class="x-icon-twitter-square" data-x-icon="" aria-hidden="true"></i></a><a href="#" class="instagram" title="Instagram" target="_blank"><i class="x-icon-instagram" data-x-icon="" aria-hidden="true"></i></a></div>

                <ul id="menu-primary-menu-2" class="x-nav"><li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-8 current_page_item menu-item-550"><a href="http://demo.theme.co/church/">Home</a></li>
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-551"><a href="http://demo.theme.co/church/about/">About</a></li>
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-552"><a href="http://demo.theme.co/church/ministries/">Ministries</a></li>
                    <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-505 tax-item tax-item-4"><a href="http://demo.theme.co/church/category/sermons/">Sermons</a></li>
                    <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-504 tax-item tax-item-3"><a href="http://demo.theme.co/church/category/news/">News</a></li>
                    <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-509 tax-item tax-item-2"><a href="http://demo.theme.co/church/category/events/">Events</a></li>
                </ul>
                <div class="x-colophon-content">
                    <h4>Services</h4>

                    <p class="footer-services">Sundays at 10am and 1pm | Wednesdays at 7pm</p>          </div>
        ...
        <div class="x-searchform-overlay">
            <div class="x-searchform-overlay-inner">
                <div class="x-container max width">
                    <form method="get" id="searchform" class="form-search center-text" action="http://demo.theme.co/church/">
                        <label for="s" class="cfc-h-tx tt-upper">Type and Press “enter” to Search</label>
                        <input id="s" class="search-query cfc-h-tx center-text tt-upper" name="s" type="text">
                    </form>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    /* <![CDATA[ */
    var wpcf7 = {"apiSettings":{"root":"http:\/\/demo.theme.co\/church\/wp-json\/contact-form-7\/v1","namespace":"contact-form-7\/v1"},"recaptcha":{"messages":{"empty":"Please verify that you are not a robot."}}};
    /* ]]> */
</script>
<script type="text/javascript" src="/js/scripts.js?ver=5.0.2"></script>
<script type="text/javascript" src="/js/site/cs-body.js?ver=3.1.1"></script>
<script type="text/javascript" src="/js/site/x.js?ver=6.1.1"></script>
<script type="text/javascript" src="/js/comment-reply.min.js?ver=4.9.6"></script>
